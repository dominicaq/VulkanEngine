...
namespace vke {
     ...
     */
    VkDeviceSize VkeBuffer::getAlignment(VkDeviceSize instanceSize, VkDeviceSize minOffsetAlignment) {
     ...
     *
     */
    void VkeBuffer::writeToBuffer(void* data, VkDeviceSize size, VkDeviceSize offset) {
     ...
     */
    VkDescriptorBufferInfo VkeBuffer::descriptorInfo(VkDeviceSize size, VkDeviceSize offset) {
     ...
     *
     */
    void VkeBuffer::writeToIndex(void* data, int index) {
     ...
     *
     */
    VkResult VkeBuffer::flushIndex(int index) { return flush(m_alignmentSize, index * m_alignmentSize); }
     ...
     */
    VkDescriptorBufferInfo VkeBuffer::descriptorInfoForIndex(int index) {
     ...
     * @return VkResult of the invalidate call
     */
    VkResult VkeBuffer::invalidateIndex(int index) {
